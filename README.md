...
It is a very simple monkey patch 
to replace hotkeys in Add and Editor window
<code>Ctrl+Shift+C</code> which cloze selected text with maximum<b>+1</b> number 
and <code>Ctrl+Alt+Shift+C</code> which cloze selected text with maximum number.

By default replacement keys are <code>Ctrl+Space</code> and <code>Ctrl+Shift+Space</code>.
